...
<div class="main-header">
    ...
    <p>Tác giả: Đỗ Thị Hằng - Tiểu học Hùng An - ĐT: 097 8811 642</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đỗ Thị Hằng - Trường Tiểu học Hùng An - ĐT: 097 8811 642</div>", unsafe_allow_html=True)
